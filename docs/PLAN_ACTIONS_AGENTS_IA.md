...
Dernière mise à jour du plan : 26 août 2026 — synchronisé avec `v0.4.0-beta.10`.
...
- Le jalon `Y = 0.4` est ouvert sur la branche `clv/y-0.4-fiabilite`, en préversion `0.4.0-beta.10`.
