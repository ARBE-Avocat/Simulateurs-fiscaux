...
- Lorsqu'une série entière ne concerne que la méthode, elle n'est pas supprimée du changelog mais **résumée en une seule phrase générale**, sans détailler les règles adoptées. Le lecteur voit qu'il s'est passé quelque chose à cette version, sans avoir à lire l'historique des conventions internes. C'est le cas de la série `0.3`, dont l'entrée stable se limitera à indiquer que les règles de gouvernance et de conception du projet ont été précisées.
